            ...
            <div class="song-list-wrap">
                ...
                <table class="list-wrap">
                    ...
                    <tbody>
                        ...
                        <tr class="list"> <!-- tr list -->
                            <td class="check"><input type="checkbox" class="select-check" title="너의 밤은 어때"></td>
                            ...
                            <td class="info">
                                <a href="#" class="sg songTitle">너의 밤은 어때</a>
                                <a href="#" class="sg songArtist">정은지</a>
                                <!-- <a href="#">가수옆작은화살표</a> 이건 제목옆 토글 -->
                                <!-- <a href="#">화살표옆 앨범타이틀</a> -->
                            </td>
                            <td class="btns">
                        ...
                        <tr class="list"> <!-- tr list -->
                            <td class="check"><input type="checkbox" class="select-check" title="Tight"></td>
                        ...
                        <tr class="list"> <!-- tr list -->
                            ...
                            <td>
                                <a href="#" class="imge">
                                    <span class="mask"></span>
                                    <img src="C:팀4/사진/지니차트/장르별차트/가요일/10.jpg" alt="에잇 (Prod. * SUGA of BTS)">
                                </a>
                            </td>
                            <td class="info">
                        ...
                        <tr class="list"> <!-- tr list -->
                            ...
                            <td>
                                <a href="#" class="imge">
                                    <span class="mask"></span>
                                    <img src="C:팀4/사진/지니차트/장르별차트/가요일/14.jpg" alt="How You Like That">
                                </a>
                            </td>
                            <td class="info">
                        ...
                        <tr class="list"> <!-- tr list -->
                            ...
                            <td class="info">
                                <a href="#" class="sg songTitle">Ice Cream</a>
                                <a href="#" class="sg songArtist">BLACKPINK</a>
                                <!-- <a href="#">가수옆작은화살표</a> 이건 제목옆 토글 -->
                                <!-- <a href="#">화살표옆 앨범타이틀</a> -->
                            </td>
                        ...
                        <tr class="list"> <!-- tr list -->
                            <td class="check"><input type="checkbox" class="select-check" title="살짝 설렛어"></td>
                            ...
                            <td class="info">
                                <a href="#" class="sg songTitle">살짝 설렛어</a>
                                <a href="#" class="sg songArtist">오마이걸</a>
                                <!-- <a href="#">가수옆작은화살표</a> 이건 제목옆 토글 -->
                                <!-- <a href="#">화살표옆 앨범타이틀</a> -->
                            </td>
                        ...
                        <tr class="list"> <!-- tr list -->
                            <td class="check"><input type="checkbox" class="select-check" title="Summer Hate"></td>
                            ...
                            <td class="info">
                                <a href="#" class="sg songTitle">Summer Hate</a>
                                <a href="#" class="sg songArtist">지코</a>
                                <!-- <a href="#">가수옆작은화살표</a> 이건 제목옆 토글 -->
                                <!-- <a href="#">화살표옆 앨범타이틀</a> -->
                            </td>
                            <td class="btns">
                        ...
                        <tr class="list"> <!-- tr list -->
                            ...
                            <td class="info">
                                ...
                                <a href="#" class="sg songArtist">유아</a>
                                <!-- <a href="#">가수옆작은화살표</a> 이건 제목옆 토글 -->
                                <!-- <a href="#">화살표옆 앨범타이틀</a> -->
                            </td>
                            <td class="btns">
