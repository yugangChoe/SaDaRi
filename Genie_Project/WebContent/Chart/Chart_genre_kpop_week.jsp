                                    ...
                                    <ul class="list_login">
                                        <li>
                                            ...
                                            <div class="login-form">
                                                <a href="#" class="btn-login" title="새창 열림" onclick="loginPopup(); return false;">
                                                    <span class="txt">
            ...
            <div class="song-list">
                <div class="song-list-wrap">
                    <div class="toolbar">
                        ...
                        <a href="#" class="btn btn-album" title="담기">담기
                        </a><a href="#" class="btn btn-down" title="다운">다운</a>
                        <div class="btns">
                            <a href="#" class="btn btn-listen" title="TOP200 듣기">TOP200 듣기</a>
                        </div><!-- btns -->
                    </div><!-- toolbar--><table class="list-wrap">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr class="list"> <!-- tr list -->
                                <td class="check"><input type="checkbox" class="select-check" title="어떻게 이별까지 사랑하겠어, 널 사랑하는거지"></td>
                                ...
                                <td class="info">
                                    <a href="#" class="sg songTitle">어떻게 이별까지 사랑하겠어, 널 사랑하는거지</a>
