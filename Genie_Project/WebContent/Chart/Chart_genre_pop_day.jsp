...
<title>Chart_genre_pop_day</title>
        <script>
            var login_st=0;
                function login(){
                    if(login_st==0){
    ...
    <div id="contents">
        ...
        <div class="chart-date">
            ...
            <ul class="select-term">
                <li><a href="/Genie_Project/G_servlet?command=Chart_genre_pop_day" class="radius ">일간</a></li>
                <li><a href="/Genie_Project/G_servlet?command=Chart_genre_pop_week" class="radius ">주간</a></li>
            </ul>
        </div><!--chart-date -->
        <div class="song-list">
                        ...
                        <tbody>
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        ...
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/1.jpg" alt="Bad Boy">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/2.jpg" alt="Holy (Feat. Chance The Rapper)">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/3.jpg" alt="2002">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/4.jpg" alt="Memories">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/5.jpg" alt="Don't Start Now">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                <td class="check"><input type="checkbox" class="select-check" title="12 : 45 (Stripped)"></td>
                                <td class="number">6</td>
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/6.jpg" alt="12 : 45 (Stripped)">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/7.jpg" alt="Maniac">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/8.jpg" alt="bad guy">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/9.jpg" alt="Painkiller">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/10.jpg" alt="Paris In The Rain">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/11.jpg" alt="All Falls Down">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/12.jpg" alt="Comethru">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/13.jpg" alt="On My Way">
                                    </a>
                                </td>
                                <td class="info">
                                    <a href="#" class="sg songTitle">On My Way</a>
                                    <a href="#" class="sg songArtist">Alan Walker & Sabrina Carpenter & Farruko</a>
                                    <!-- <a href="#">가수옆작은화살표</a> 이건 제목옆 토글 -->
                                    <!-- <a href="#">화살표옆 앨범타이틀</a> -->
                                </td>
                                 <td class="btns">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/14.jpg" alt="Juice">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/15.jpg" alt="Senorita">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/16.jpg" alt="Shape Of You">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/17.jpg" alt="Watermelon Sugar">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/18.jpg" alt="To Die For">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/19.jpg" alt="YOUTH">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/20.jpg" alt="The Ocean">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/21.jpg" alt="Bad">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/22.jpg" alt="Believer">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/23.jpg" alt="Faded">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/24.jpg" alt="One Call Away">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/25.jpg" alt="Birthday">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/26.jpg" alt="Attention">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/27.jpg" alt="Holy (Feat. Chance The Rapper)">
                                    </a>
                                </td>
                                <td class="info">
                                    <a href="#" class="sg songTitle">Holy (Feat. Chance The Rapper)</a>
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/28.jpg" alt="Say So">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/29.jpg" alt="ROXANNE">
                                    </a>
                                </td>
                                <td class="info">
                            ...
                            <tr class="list"> <!-- tr list -->
                                ...
                                <td>
                                    <a href="#" class="imge">
                                        <span class="mask"></span>
                                        <img src="C:/팀4/사진/지니차트/장르별차트/팝/팝일간/30.jpg" alt="Holy (Feat. Chance The Rapper)">
                                    </a>
                                </td>
                                <td class="info">
                                    <a href="#" class="sg songTitle">Holy (Feat. Chance The Rapper)</a>
