...
<div id="div1">
        <header>
            <div><img src="C:\팀4\사진\이미지/genie이미지.jpg" width="80px" height="40px"></div>
        </header>
        <body>
            <div>
            <fieldset style="width:220px; text-align: center; color: white; margin-left: 120px;">
            ...
            <fieldset style="font-size: 20px;width:220px; text-align: right; color: white; margin-left: 120px;">
                <label onclick="color()" id="heart"><strong>♡</strong></label>
                <label><small>더보기</small></label>
            </fieldset>
            </div>
<fieldset style="width:220px; text-align: center;margin-left: 120px;">
    <label id="songimg"><img src="C:/팀4/사진/지니차트/TOP 200/일간/1.jpg" width="220px" height="220px"></label><label id="aa"></label>
</fieldset>
<fieldset style="width:220px; text-align: center;margin-left: 120px;color: white;">
    <label>--재생중--</label>
</fieldset>
<fieldset>
    <table style="width: 300px;height: 50px;color: white;font-weight: bolder;font-size: 30px; margin-left: 100px;margin-top: 10px;">
        <tr><td colspan="5">-----------------------</td></tr>
        <tr><td>⟲</td><td>↶</td><td onclick="play()" id="play">▷</td><td>↷</td><td>⟳</td></tr>
    </table>
</fieldset>
...
<footer style="margin-top: 55px;">
    ...
    <fieldset>
    <label style="color:white;text-align: left;margin-left: 20px;"><small>로그인 후, 전곡 스트리밍을 이용해 보세요.</small></label>
    <label style="color:white;text-align: right;margin-left: 40px;" onclick="login()"><label id="lab1" style="border: 1px solid white; border-radius: 5px;margin-left: 68px;margin-right: 0px;"><small>이용권 구매</small></label>
    </fieldset>
</footer>
    </div>
    ...
    <div id="div2">
        <fieldset id="rf1">
<a href="" onclick="login()" style="color: white; font-size: 13px;">로그인하세요 ></a> 
<span id="faq" style="color: white;margin-left:10px;font-size: 13px;">이용안내 </span> <span id="yi" style="color: white;font-size: 13px;">FAQ </span>
</fieldset>
<div id="rd1">
<button id="rb1" style="border: 1px solid white;">재생목록</button>
<button id="rb2" onclick="login()" style="background-color: #f6f7fb;border: 1px solid #d9dde9;color: #b5a5ba;">마이뮤직</button>

</div>
<div id="rd2">
    <button id="rb3" style="font-size: 13px; padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: white;">중복곡 삭제</button>
    <div class="dropdown" id="rdd1">
        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false" style="color:black;font-size: 13px;padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: #f6f7fb;">
            재생목록 동기화
        </button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="#">현재목록 올리기</a>
            <a class="dropdown-item" href="#">동기화 목록 내려받기</a>
            <a class="dropdown-item" href="#">동기화 목록 보기</a>
        </div>
    </div>
    <div class="dropdown" id="rdd2">
        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false" style="color: black;font-size: 13px; padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: #f6f7fb; width: 70px;">
            곡명순
        </button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="#" style="font-size: 13px;">곡명 역순</a>
            <a class="dropdown-item" href="#" style="font-size: 13px;">아티스트명순</a>
            <a class="dropdown-item" href="#" style="font-size: 13px;">아티스트명 역순</a>
            <a class="dropdown-item" href="#" style="font-size: 13px;">앨범명순</a>
            <a class="dropdown-item" href="#" style="font-size: 13px;">앨범명 역순</a>
            <a class="dropdown-item" href="#" style="font-size: 13px;">셔플</a>
...
<div id="toolbar">
    <tr>
        <td ><input type="checkbox"  style="margin-top:25px; margin-left: 20px;"></td>
        <td> <input type="button" value="▲" style="font-size: 13px; margin: 0px;padding:4px; border: 1px solid #d9dde9;border-radius: 4px;background-color: white;">
            <input type="button" value="▼" style="font-size: 13px; margin: 0px;padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: white;"></td>
        <td colspan="3"><input type="button" value="담기" style="font-size: 13px; margin: 0px;padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: white;">
            <input type="button" value="다운" style="font-size: 13px; margin: 0px;padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: white;">
            <input type="button" value="삭제" style="font-size: 13px; margin: 0px;padding:4px;border: 1px solid #d9dde9;border-radius: 4px;background-color: white;"> </td>
        <td><span id="span1" style="margin-left:150px; color: aqua;">3</span><span style="color: aqua;">곡</span><span> / </span><span>5</span><span>곡</span></td>
    </tr>
